...
### ② -B ／ タイトルの text-shadow を削除（352〜358行目）

タイトル位置（vertical 60〜90%）はグラデーションの暗いゾーン（0.55〜0.85）の上に乗るため、シャドウなしでも白文字の可読性が確保できます。むしろシャドウがあると黒の存在感が出て写真の質感を損ねるため、完全に削除します。
